...
def human_delay(min_sec=2, max_sec=5):
    """হিউম্যান টাইপিং ও ক্লিকিং সিমুলেট করতে র‍্যান্ডম ডিলে"""
    time.sleep(random.uniform(min_sec, max_sec))

def random_typing_speed():
    """টাইপিং স্পিড সিমুলেট করতে র‍্যান্ডম ডিলে"""
    return random.uniform(0.2, 0.8)

def random_user_agent():
    """র‍্যান্ডম ইউজার এজেন্ট জেনারেট করে"""
    user_agents = [
...
def generate_username():
    """র‍্যান্ডম ইউজারনেম জেনারেট করে (হিউম্যান-লাইক)"""
...
def generate_password():
    """স্ট্রং পাসওয়ার্ড জেনারেট করে"""
    import string
    chars = string.ascii_letters + string.digits + "!@#$%"
    return ''.join(random.choice(chars) for _ in range(12))

def generate_full_name():
    """র‍্যান্ডম নাম জেনারেট করে"""
...
async def phone_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ব্যাকগ্রাউন্ডে ইনস্টাগ্রাম ক্লায়েন্ট শুরু করুন
    cl = Client()
    cl.set_user_agent(random_user_agent())
    user_data_store[user_id]["cl"] = cl
    
    # ফোন নম্বর পাঠানোর চেষ্টা
    try:
...
async def code_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        # লগইন করে অ্যাকাউন্ট তৈরি করুন (স্মল ডিলে দিয়ে)
        ...
        # প্রোফাইল আপডেট করুন (ইউজারনেম, নাম, বায়ো)
        ...
        # 2FA ইতিমধ্যে সক্রিয় থাকলে (খুবই বিরল)
